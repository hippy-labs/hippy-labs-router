...
} from "../../../hippy-vue-next/src/config";
...
describe("style-match/index.ts", () => {
  ...
  it("getCssMap should work correctly with ssr ast", () => {
    ...
    const ssrTestAst = [
      ...
      [["*"], [["UniversalSelector-chunk-2", "UniversalSelector-chunk-2"]]],
    ];
  ...
  it("fromSsrAstNodes should work correctly", () => {
    const ssrAst = [
      [['#id[attr|="dash"]'], [["AttributeSelector", "AttributeSelector"]]],
    ];
