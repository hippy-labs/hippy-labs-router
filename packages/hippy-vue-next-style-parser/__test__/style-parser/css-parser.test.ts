...
import {
  ...
  parseCSS,
} from "../../src/style-parser/css-parser";
...
describe("style-parser/css-parser.ts", () => {
  ...
  it("parseBackgroundImage should work correctly", () => {
    ...
    expect(
      parseBackgroundImage(
        "backgroundImage",
        "url('https://mat1.gtimg.com/www/qq2018/imgs/qq_logo_2018x2.png')",
      ),
    ).toEqual(urlBgImg);
    const url = [
      "backgroundImage",
  ...
  it("parseCSS should work correctly", () => {
    ...
    const [root, header, leftTitle, backBtn, title, bodyContainer] =
