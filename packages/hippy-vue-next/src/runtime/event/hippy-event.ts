...
export class HippyEvent {
  ...
  public target: HippyElement | null = null;

  // the current object that triggered the event, which is changing as the event bubbles up
  public currentTarget: HippyElement | null = null;

  public originalTarget: HippyElement | null = null;
...
export function eventIsKeyboardEvent(
  event: HippyEvent,
): event is HippyKeyboardEvent {
...
export type MapToUnion<I> = {
  [k in keyof I]: { __evt: k; handler: I[k] };
}[keyof I];
