...
describe("runtime/element/hippy-element", () => {
  ...
  describe("test the element operation methods.", () => {
    describe("append child element.", () => {
      it("should update the tree level properties after appending element.", () => {
        ...
        expect(
          childHippyElementPre.parentNode === parentHippyElement &&
            childHippyElementNext.parentNode === parentHippyElement,
        ).toBeTruthy();
        expect(parentHippyElement.childNodes.length).toBe(2);
        expect(
          parentHippyElement.firstChild === childHippyElementPre,
        ).toBeTruthy();
        expect(
          parentHippyElement.lastChild === childHippyElementNext,
        ).toBeTruthy();
        expect(
          childHippyElementPre.nextSibling === childHippyElementNext,
        ).toBeTruthy();
        expect(
          childHippyElementNext.prevSibling === childHippyElementPre,
        ).toBeTruthy();
      });
    });
    ...
    describe("move child element.", () => {
      it("should update the tree level properties after move element.", () => {
        ...
        expect(
          parentHippyElement.firstChild === childHippyElementLast,
        ).toBeTruthy();
        expect(
          parentHippyElement.lastChild === childHippyElementMiddle,
        ).toBeTruthy();
        expect(
          childHippyElementFirst.prevSibling === childHippyElementLast,
        ).toBeTruthy();
        expect(
          childHippyElementLast.nextSibling === childHippyElementFirst,
        ).toBeTruthy();
      });
    });
    ...
    describe("remove child element.", () => {
      it("should update the tree level properties after remove element.", () => {
        ...
        expect(
          parentHippyElement.firstChild === childHippyElementMiddle,
        ).toBeTruthy();
  ...
  describe("methods related to attributes.", () => {
    ...
    it("color string value should be convert to native number", () => {
      ...
      expect(element.attributes.nativeBackgroundAndroid.color).toEqual(
        285212672,
      );
    ...
    it("element text attribute should be string", () => {
      ...
      expect(() => element.setAttribute("defaultValue", undefined)).toThrow(
        TypeError,
      );
      expect(() => element.setAttribute("placeholder", undefined)).toThrow(
        TypeError,
      );
    });
  });
  ...
  describe("set style of hippy-element.", () => {
    ...
    it("should set the backgroundImage style.", () => {
      ...
      expect(hippyElement.style.backgroundImage).toBe(
        "https://mat1.gtimg.com/www/qq2018/imgs/qq_logo_2018x2.png",
      );
    });
  ...
  it("setStyleScopedId method should work correct", () => {
    ...
    expect(element.styleScopeId).toEqual([
      "style-scoped-id",
      "[object Object]",
    ]);
