...
describe("built-in-component", () => {
  ...
  describe("each type of tag should contain there property", () => {
    it("div tag test", () => {
      ...
      expect(nativeNode?.props?.style?.backgroundImage).toEqual(
        `${HIPPY_DEBUG_ADDRESS}assets/index.png`,
      );
      expect(
        (divElement.childNodes[0] as HippyElement).getAttribute("collapsable"),
      ).toBeFalsy();
    ...
    it("img tag test", () => {
      ...
      expect(nativeNode?.props?.defaultSource).toEqual(
        "https://hippyjs.org/index.png",
      );
    ...
    it("li tag test", () => {
      ...
      expect(listItemElement.component.name).toEqual(
        NATIVE_COMPONENT_MAP.ListViewItem,
      );
    ...
    it("input tag test", () => {
      ...
      expect(inputElement.component.name).toEqual(
        NATIVE_COMPONENT_MAP.TextInput,
      );
    ...
    it("textarea tag test", () => {
      ...
      expect(textareaElement.component.name).toEqual(
        NATIVE_COMPONENT_MAP.TextInput,
      );
    });
    ...
    it("iframe tag test", () => {
      ...
      expect(iframeElement.component.name).toEqual(
        NATIVE_COMPONENT_MAP.WebView,
      );
